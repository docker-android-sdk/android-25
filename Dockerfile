...
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "platforms;android-25"
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "system-images;android-25;google_apis;x86_64"
